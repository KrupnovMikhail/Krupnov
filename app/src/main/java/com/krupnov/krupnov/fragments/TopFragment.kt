...
class TopFragment : ParentFragment() {
    ...
    override fun onCreateView(
        ...
        val buttonBack: ImageButton = view.findViewById(R.id.buttonBack2) as ImageButton
        buttonBack.setOnClickListener { back() }

        val buttonNext: ImageButton = view.findViewById(R.id.buttonNext2) as ImageButton
